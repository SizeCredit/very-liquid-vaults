...
contract ERC4626StrategyVaultAssetFeeOnWithdrawERC4626StdTest is ERC4626Test, BaseTest {
    function setUp() public override(ERC4626Test, BaseTest) {
        ...
        _vault_ = address(erc4626StrategyVaultAssetFeeOnWithdraw);
        _delta_ = 0;
    ...
    function test_withdraw_01() public {
        Init memory init = Init({
            user: [
                0x00000000000000000000000000000000000051Dc,
                0x0000000000000000000000000000000000001078,
                0x0000000000000000000000000000000000003a5b,
                0x000000000000000000000000000000000000314A
            ],
            share: [uint256(13729), uint256(2265872196), uint256(4552), uint256(5528)],
            asset: [uint256(5419), uint256(21433), uint256(6417), uint256(4931)],
            yield: int256(7153)
        });
        test_withdraw(init, 1861, 10419);
    }
}
