...
contract VeryLiquidVaultRVTest is ERC4626Test, Setup {
  function setUp() public {
    deploy(address(this));
    ERC4626Test.init(address(veryLiquidVault));
    _setupRandomVeryLiquidVaultConfiguration(address(this), _getRandomUint);
  }
