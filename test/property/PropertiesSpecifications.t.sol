...
abstract contract PropertiesSpecifications {
    ...
    string constant SOLVENCY_02 =
        "SOLVENCY_02: Direct deposit to strategy should not change convertToAssets(balanceOf) of the very liquid";
    ...
    string constant STRATEGY_02 = "STRATEGY_02: The VeryLiquidVault always has at least 1 strategy"; // implemented
    string constant TOTAL_ASSETS_CAP_01 =
        "TOTAL_ASSETS_CAP_01: Deposit/Mint cannot lead to totalAssets() > totalAssetsCap()"; // implemented
