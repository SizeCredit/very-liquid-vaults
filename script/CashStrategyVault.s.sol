...
contract CashStrategyVaultScript is Script {
        ...
        returns (CashStrategyVault cashStrategyVault)
    {
        ...
        string memory symbol = string.concat("sizeCash", IERC20Metadata(address(sizeVault_.asset())).symbol());
        ...
        IERC20(address(sizeVault_.asset())).forceApprove(address(cashStrategyVault), firstDepositAmount_);
        Create2.deploy(
