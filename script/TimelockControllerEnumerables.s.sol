...
contract TimelockControllerEnumerablesScript is Script {
    ...
    function run() public {
        ...
        TimelockControllerEnumerable timelockController_DEFAULT_ADMIN_ROLE =
            new TimelockControllerEnumerable(7 days, adminTimelockAddresses, adminTimelockAddresses, msg.sender);
        ...
        TimelockControllerEnumerable timelockController_VAULT_MANAGER_ROLE =
            new TimelockControllerEnumerable(1 days, vaultManagerAddresses, vaultManagerAddresses, msg.sender);
    ...
    function deploy(uint256 minDelay_, address[] memory proposers_, address[] memory executors_, address admin_)
        public
        returns (TimelockControllerEnumerable)
    {
